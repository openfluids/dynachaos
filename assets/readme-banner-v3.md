...
```text
The classic logistic-map period-doubling bifurcation diagram, drawn as an exquisitely fine hairline scientific line drawing. ONE single delicate hairline cyan curve enters from the LEFT edge and runs calm and level across the empty left third. At a first point it divides smoothly into TWO hairline curves that bend gently apart, like the two tines of a tuning fork [...] giving FOUR [...] giving EIGHT. After the eighth branching, at the extreme RIGHT edge only, the curves blur into a fine faint mist of chaos with a few tiny coral specks. Do NOT draw connecting bars, rungs, boxes, grids or lattices; do NOT draw a smooth continuous fan.
```
