...
| README Kaneko section; JOSS Research impact | reproduction gallery is the flagship application and stress test, not the package boundary | supported-by: manuscript/reproduction pipeline; scope claim reframed |
